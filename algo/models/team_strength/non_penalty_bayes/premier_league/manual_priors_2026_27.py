...
sigma=0.125. Relegated (real, penalty-inclusive 2025-26 table): Burnley, West Ham, Wolves.
...
_RAW_ATT = {
             'Arsenal': (0.263, 0.125),
         'Aston Villa': (0.025, 0.125),
         'Bournemouth': (0.081, 0.125),
           'Brentford': (0.036, 0.125),
            'Brighton': (0.068, 0.125),
             'Chelsea': (0.202, 0.125),
      'Crystal Palace': (-0.042, 0.125),
             'Everton': (-0.063, 0.125),
              'Fulham': (-0.146, 0.125),
               'Leeds': (-0.068, 0.125),
           'Liverpool': (0.218, 0.125),
            'Man City': (0.338, 0.125),
          'Man United': (0.202, 0.125),
           'Newcastle': (0.051, 0.125),
        'Nottm Forest': (-0.049, 0.125),
          'Sunderland': (-0.245, 0.125),
           'Tottenham': (-0.006, 0.125),
...
_RAW_DEF = {
             'Arsenal': (-0.450, 0.125),
         'Aston Villa': (0.037, 0.125),
         'Bournemouth': (0.022, 0.125),
           'Brentford': (-0.021, 0.125),
            'Brighton': (-0.081, 0.125),
             'Chelsea': (-0.092, 0.125),
      'Crystal Palace': (-0.010, 0.125),
             'Everton': (0.050, 0.125),
              'Fulham': (0.040, 0.125),
               'Leeds': (0.046, 0.125),
           'Liverpool': (-0.104, 0.125),
            'Man City': (-0.215, 0.125),
          'Man United': (-0.074, 0.125),
           'Newcastle': (-0.004, 0.125),
        'Nottm Forest': (0.015, 0.125),
          'Sunderland': (0.050, 0.125),
           'Tottenham': (-0.018, 0.125),
    # Promoted sides — wider prior
                'Hull': (0.491, 0.15),
            'Coventry': (0.248, 0.15),
             'Ipswich': (0.241, 0.15),
