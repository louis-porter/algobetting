...
def build_and_sample_model(train_df, n_teams, current_season=None, league=None, 
    ...
    with pm.Model() as model:
        ...
        sigma_att = 0.5 #pm.HalfNormal("sigma_att", sigma=1.5)
        sigma_def = 0.5 #pm.HalfNormal("sigma_def", sigma=1.5)
        ...
        home_adv = pm.Normal("home_adv", mu=1, sigma=0.5)
        baseline = pm.Normal("baseline", mu=1, sigma=0.5)
