...
def load_football_data(db_path: str, league: str, season: str) -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    """
...
def load_and_process_data(db_path: str, league: str, season: str, 
