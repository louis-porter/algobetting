...
feature_cols = ["match_url", "match_date", "season", "division", "team", "opp_team", "is_home", "shots", "opp_shots",
                # attack metrics
...
features_df.to_sql('fbref_team_shots_features_005_365', conn, if_exists='replace', index=False)
