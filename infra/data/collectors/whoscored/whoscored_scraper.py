...
match_urls = main.getMatchUrls(comp_urls=league_urls, competition='england-premier-league', season='2025/2026')

# Convert dates for ALL matches
for match in match_urls:
    match['date_dt'] = datetime.strptime(match['date'], '%A, %b %d %Y')

match_urls = [match for match in match_urls if start <= match['date_dt'] <= end]
